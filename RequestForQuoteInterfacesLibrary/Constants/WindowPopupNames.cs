...
{
    public static class WindowPopupNames
    {
        public const string BOOK_MAINTENANCE_WINDOW_POPUP = "BookMaintenanceWindowPopup";
        public const string SAVE_SEARCH_WINDOW_POPUP = "SaveSearchWindowPopup";
        public const string CLIENT_MAINTENANCE_WINDOW_POPUP = "ClientMaintenanceWindowPopup";
        public const string USER_MAINTENANCE_WINDOW_POPUP = "UserMaintenanceWindowPopup";
