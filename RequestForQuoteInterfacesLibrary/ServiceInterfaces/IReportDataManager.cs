...
namespace RequestForQuoteInterfacesLibrary.ServiceInterfaces
{
    public interface IReportDataManager
    {
        ...
        void CompileGreeksPerCategoryReport(string reportType, string categoryType, ISet<string> greeks, DateTime maturityDateFrom, DateTime maturityDateTo, double minimumGreek);
    }
}